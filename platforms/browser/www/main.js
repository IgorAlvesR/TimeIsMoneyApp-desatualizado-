...
/* harmony import */ var _guards_login_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./guards/login.guard */ "./src/app/guards/login.guard.ts");
...
var routes = [
    ...
    { path: 'entrar', loadChildren: './pages/entrar/entrar.module#EntrarPageModule', canActivate: [_guards_login_guard__WEBPACK_IMPORTED_MODULE_1__["LoginGuard"]] },
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_fire__WEBPACK_IMPORTED_MODULE_10__["AngularFireModule"].initializeApp(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_11__["environment"].firebase),
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(servicoAutenticacao, navCtrl) {
    ...
    AuthGuard.prototype.canActivate = function () {
        ...
        return new Promise(function (resolve) {
            _this.servicoAutenticacao.getAuth().onAuthStateChanged(function (funcionario) {
                if (!funcionario) {
                    _this.navCtrl.navigateRoot(['entrar']);
                }
...
var LoginGuard = /** @class */ (function () {
    ...
    LoginGuard.prototype.canActivate = function () {
        ...
        return new Promise(function (resolve) {
            _this.servicoAutenticacao.getAuth().onAuthStateChanged(function (funcionario) {
                if (funcionario) {
                    _this.navCtrl.navigateRoot('registro-hora-extra').then(function (res) {
...
var AutenticacaoService = /** @class */ (function () {
    function AutenticacaoService(afa, afs) {
        this.afa = afa;
        this.afs = afs;
...
/***/ "./src/app/servicos/hora-extra.service.ts":
/*!************************************************!*\
  !*** ./src/app/servicos/hora-extra.service.ts ***!
  \************************************************/
/*! exports provided: HoraExtraService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HoraExtraService", function() { return HoraExtraService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var HoraExtraService = /** @class */ (function () {
    function HoraExtraService(afs, authService) {
        ...
        this.userId = authService.getAuth().currentUser.uid;
        this.colecaoHoraExtraRegistro = this.afs.collection('HoraExtra');
        this.colecaoHoraExtra = this.afs.collection('HoraExtra', function (ref) { return ref.where('userId', '==', _this.userId); });
    }
    ...
    HoraExtraService.prototype.update = function (horaExtra) {
        ...
        var horaInicial;
        var horasOb;
        var snapshotResult = this.afs.collection('HoraExtra', function (ref) { return ref.limit(1).orderBy("cont", "desc"); })
            .snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(function (horasOb) { return horasOb; }));
...
var environment = {
    production: true,
    firebase: {
        apiKey: "AIzaSyBVrQG4uTrNe6lAnHAFVC6TTEArxJtrtVw",
        authDomain: "apptimeismoney-1cc1d.firebaseapp.com",
        databaseURL: "https://apptimeismoney-1cc1d.firebaseio.com",
        projectId: "apptimeismoney-1cc1d",
        storageBucket: "",
        messagingSenderId: "785642783362",
        appId: "1:785642783362:web:3626c8497599bcb1"
    }
};
